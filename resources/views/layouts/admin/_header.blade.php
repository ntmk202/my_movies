<!-- Navbar-->
<header class="app-header" style="background: #426094;">
    
    <!-- Sidebar toggle button-->
    <a class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"></a>

    <a class="app-header__logo" style="font-family: 'Cairo', 'sans-serif'; background: #426094;" href="{{ route('admin.home') }}">Movie Dashboard</a>
